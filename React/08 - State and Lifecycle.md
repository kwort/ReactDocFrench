...
## Ajout d'un state local à une classe
...
## Ajout de méthodes Lifecycle à une classe
...
### Les mises à jour de state peuvent être asynchrones
...
### Les mises à jour de state sont fusionnées
...
## Les flux de données descendant
